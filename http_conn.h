...
public:
    ...
    static const int WRITE_BUFFER_SIZE = 1034; //写缓冲区的大小
...
public:
    static int m_epollfd;   //所有socket上的事件都被注册到同一个内核事件中
...
private:
    ...
    char* m_version;                        //HTTP协议的版本号，该项目仅支持HTTP1.1
    char* m_host;                           //主机名
